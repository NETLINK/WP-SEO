			...
			<table class="form-table">
				<tr>
					...
					<td>
						...
						echo '<p class="description">', __( 'WP SEO has auto-detected whether it needs to force rewrite the titles for your pages, if you think it\'s wrong and you know what you\'re doing, you can change the setting here.', 'wordpress-seo' ), '</p>';
						?>
					</td>
				</tr>
				<tr>
		...
		<div id="post_types" class="wpseotab">
			...
			if ( is_array( $post_types ) && $post_types !== array() ) {
				foreach ( $post_types as $pt ) {
					...
					$yform->checkbox( 'hideeditbox-' . $name, __( 'Hide', 'wordpress-seo' ), __( 'WP SEO Meta Box', 'wordpress-seo' ) );
		...
		<div id="taxonomies" class="wpseotab">
			...
			if ( is_array( $taxonomies ) && $taxonomies !== array() ) {
				foreach ( $taxonomies as $tax ) {
					...
					$yform->checkbox( 'hideeditbox-tax-' . $tax->name, __( 'Hide', 'wordpress-seo' ), __( 'SEO Meta Box', 'wordpress-seo' ) );
					echo '<br/><br/>';
				}
				unset( $tax );
			}
