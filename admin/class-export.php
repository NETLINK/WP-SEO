...
class WPSEO_Export {
	...
	public function get_results() {
		...
		if ( $this->success ) {
			...
			$results['msg']    = __( 'Error creating WP SEO export: ', 'wordpress-seo' ) . $this->error;
		}
	...
	private function export_header() {
		$this->write_line( '; ' . __( 'This is a settings export file for the SEO plugin', 'wordpress-seo' ) );
