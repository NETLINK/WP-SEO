...
class WPSEO_Admin {
	...
	function register_settings_page() {
		...
		// Add main page
		$admin_page = add_menu_page( __( 'SEO:', 'wordpress-seo' ) . ' ' . __( 'General Settings', 'wordpress-seo' ), __( 'SEO', 'wordpress-seo' ), 'manage_options', 'wpseo_dashboard', array(
			$this,
			'load_page',
		), $icon_svg, '99.31337' );
		...
		if ( count( $submenu_pages ) ) {
			foreach ( $submenu_pages as $submenu_page ) {
				...
				// Add submenu page
				$admin_page = add_submenu_page( $submenu_page[0], $submenu_page[2] . ' - ' . __( 'SEO', 'wordpress-seo' ), $submenu_page[2], $submenu_page[3], $submenu_page[4], $submenu_page[5] );
	...
	function title_metas_help_tab() {
		...
		$screen->add_help_tab(
			array(
				...
				'content' => '<p>' . __( 'The title &amp; metas settings for WP SEO are made up of variables that are replaced by specific values from the page when the page is displayed. The tabs on the left explain the available variables.', 'wordpress-seo' ) . '</p>' . '<p>' . __( 'Note that not all variables can be used in every template.', 'wordpress-seo' ) . '</p>',
			)
		);
	...
	function register_network_settings_page() {
		if ( WPSEO_Utils::grant_access() ) {
			// Base 64 encoded SVG image
			$icon_svg = 'data:image/svg+xml;base64,';
			add_menu_page( __( 'SEO:', 'wordpress-seo' ) . ' ' . __( 'MultiSite Settings', 'wordpress-seo' ), __( 'SEO', 'wordpress-seo' ), 'delete_users', 'wpseo_dashboard', array(
				$this,
				'network_config_page',
			), $icon_svg );

			if ( WPSEO_Utils::allow_system_file_edit() === true ) {
				add_submenu_page( 'wpseo_dashboard', __( 'SEO:', 'wordpress-seo' ) . ' ' . __( 'Edit Files', 'wordpress-seo' ), __( 'Edit Files', 'wordpress-seo' ), 'delete_users', 'wpseo_files', array(
					$this,
					'load_page',
				) );
			}
			...
			// Add Extension submenu page
			add_submenu_page( 'wpseo_dashboard', __( 'SEO:', 'wordpress-seo' ) . ' ' . __( 'Extensions', 'wordpress-seo' ), __( 'Extensions', 'wordpress-seo' ), 'delete_users', 'wpseo_licenses', array(
				$this,
				'load_page',
			) );
		}
	...
	function meta_description_warning() {
		...
		printf( '
			...
			sprintf( __( 'Your theme contains a meta description, which blocks the SEO plugin from working properly. Please visit the %sSEO Dashboard%s to fix this.', 'wordpress-seo' ), sprintf( '<a href="%s">', esc_url( admin_url( 'admin.php?page=wpseo_dashboard' ) ) ), '</a>' ),
			esc_js( wp_create_nonce( 'wpseo-ignore' ) ),
			__( 'I know, don\'t bug me.', 'wordpress-seo' )
		);
	}
