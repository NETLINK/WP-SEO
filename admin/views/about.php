...
<div class="wrap about-wrap">
	...
	<h1><?php _e( 'Thank you for updating!', 'wordpress-seo' ); ?></h1>
		...
		<div class="changelog feature-list finer-points">
			...
			<div class="feature-section col two-col">
				...
				<div class="last-feature">
					...
					<p>
						<?php _e( 'This release has made the code of WP SEO that runs on the frontend of your site approximately 30% faster.', 'wordpress-seo' ); ?>
					</p>
				</div>
				...
				<div class="last-feature">
					...
					<p>
						<?php printf( __( 'WP SEO ships, at time of release, with 26 translations, of which 10 are complete. That\'s a huge improvement from last time, and we\'re improving every week. Join us at %1$stranslate.yoast.com%2$s!', 'wordpress-seo' ), '<a target="_blank" href="https://translate.yoast.com/projects/wordpress-seo">', '</a>' ); ?>
					</p>
				</div>
			</div>
		</div>
	...
	<div id="v221" class="wpseotab">
		...
		<ul class="ul-disc">
			...
			<li>Makes all WP SEO notices dismissible.</li>
		</ul>
		...
		<ul class="ul-disc">
			...
			<li>Fixes a bug where sitemap cache was not always cleared after saving the WP SEO settings.</li>
		</ul>
		...
		<p>SEO 2.1 adds some more features on top of this release. Read the release notes for more info.</p>
		<ul class="ul-disc">
	...
	<div id="credits" class="wpseotab">
		<p class="about-description">
			<?php
				printf( __( 'While most of the development team is at %1$sYoast%2$s in the Netherlands, WP SEO is created by a worldwide team.', 'wordpress-seo' ), '<a target="_blank" href="https://yoast.com/">', '</a>' );
				echo ' ';
