...
class Yoast_Plugin_Conflict {
	...
	protected function set_error( $plugin_section, $readable_plugin_section ) {
		...
		$error_message .= '<p>' . sprintf( __( 'The %s plugin(s) might cause issues when used in conjunction with WP SEO.', 'wordpress-seo' ), $plugins_as_string ) . '</p>';
		...
		/* translators: %s: 'Facebook & Open Graph' plugin name(s) of possibly conflicting plugin(s) */
		$error_message .= sprintf( __( 'We recommend you deactivate %s and have another look at your SEO configuration using the button above.', 'wordpress-seo' ), $plugins_as_string ) . '</p>';
		...
		$error_message .= '<p class="alignright"><small>' . __( 'This warning is generated by WP SEO.', 'wordpress-seo' ) . '</small></p><div class="clear"></div>';
